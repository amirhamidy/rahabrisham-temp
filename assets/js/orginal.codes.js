...
function kioto_tm_modalbox(){
    ...
    jQuery('.kioto_tm_all_wrap').prepend('<div class="kioto_tm_modalbox"><div class="box_inner"><div class="close"><a style="background-color: white;border-radius: 1px" href="#"><i class="text-center align-items-center"><svg style="width: 1em !important; height: 1em !important; margin-top: 11px ; margin-left: 5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="2em" height="2em"><g fill="white" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="4"><path d="M8 8L40 40"></path><path d="M8 40L40 8"></path></g></svg></i></a></div><div class="description_wrap"></div></div></div>');
}
...
function kioto_tm_modalbox_news(){
    ...
    button.on('click',function(){
        ...
        modalBox.find('.news_popup_informations').prepend('<div style="display: none;" class="image"><img src=" assets/media/img/favicon.webp" alt=""></div><div class="main" data-img-url="'+image+'"></div></div>');
...
function kioto_tm_modalbox_portfolio(){
    ...
    button.on('click',function(){
        ...
        modalBox.find('.popup_details').prepend('<div style="display: none;" class="top_image"><img src="assets/media/img/favicon.webp" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
...
function kioto_tm_hover_image(){
    ...
    jQuery('body').prepend('<div class="hover_image"><div class="abs_image"><div class="main"></div></div></div>');
}
...
function kioto_tm_ripple(){
    ...
    document.querySelector('.close-in-page').addEventListener('click', function() {
    Swal.fire({
        title: 'آیا از تصمیم خود مطمئن هستید؟',
        showCancelButton: true,
        confirmButtonText: '<a href="" style="color: white; text-decoration: none;">بله</a>',
